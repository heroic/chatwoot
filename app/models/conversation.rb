...
class Conversation < ApplicationRecord
  ...
  after_create_commit :notify_conversation_creation, :queue_conversation_auto_resolution_job, :queue_fetch_contact_external_details
  ...
  def queue_fetch_contact_external_details
    FetchContactDetailsJob.perform_later(contact_id)
  end
